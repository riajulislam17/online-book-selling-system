            ...
            <ul class="list-group mb-3">
                @if($carts->count())
                    ...
                    @foreach($carts as $cart)
                        @php
                            $totalPrice += $cart->quantity * $cart->associatedModel->price;
                        @endphp
                        <li class="list-group-item d-flex justify-content-between lh-condensed">
                            <div>
                               <div class="">
                                   <span class="my-0 h6"> {{$cart->associatedModel->book_name}}</span> <small>{{ $cart->quantity }}X</small>
                               </div>
                                <small class="text-muted"> {{$cart->associatedModel->seller->shop_name}}</small>
                            </div>
                            <span class="text-muted">{{$cart->associatedModel->price * $cart->quantity}}</span>
                        </li>
                    @endforeach
                ...
                @else
                    <li class="list-group-item d-flex justify-content-between">
                        <span class="h3">Cart is Empty</span>
                    </li>
                @endif
            </ul>
        </div>
