           ...
           <div class="border shadow p-5">
               ...
               <div class="input-group mb-4">
                   ...
                   <span class="input-group-text">
                       <i class="fa fa-store-alt p-1"></i>
                   </span>
                   </div>
                   <input type="text" class="form-control" name="shop_name" placeholder="Shop Name" aria-label="shop_name" aria-describedby="basic-addon1">
               </div>
