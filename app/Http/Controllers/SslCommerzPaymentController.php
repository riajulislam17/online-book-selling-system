...
class SslCommerzPaymentController extends Controller
{
    ...
    public function exampleEasyCheckout()
    {
        ...
        return view('invoices.exampleEasycheckout', ['customer' => $customer, 'carts' => $cartCollection]);
    }

    public function exampleHostedCheckout()
    {
        return view('invoices.exampleHosted');
    }
    ...
    {
        $serverStatus =  "Transaction is Successful";
        ...
        if ($order_detials->status == 'Pending') {
            ...
            if ($validation == TRUE) {
                ...
                */
                ...
                $databaseStatus = "validation Fail";
            }
            ...
            $databaseStatus = "Invalid Transaction";
        }
        ...
        return view('invoices.success', ['tnx' => (object)$response]);
    }
